...
int main(int argc, char *argv[])
{
     ...
     */
    if (isTreeOrderedWrong(root))
        printf("The tree is (wrong) ordered...!\n");
    else
        printf("The tree is (wrong) not ordered...!\n");

    if (isTreeOrdered(root))
        printf("The tree is (right) ordered...!\n");
    else
        printf("The tree is (right) not ordered...!\n");
