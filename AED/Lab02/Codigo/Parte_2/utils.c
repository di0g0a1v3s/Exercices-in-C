 ...
 * Side-Effects: none
 *
 * Description: output all words and ocurrences to file, from the beggining to the end of the list
 *
 *****************************************************************************/

void escrevePalavrasInicio(t_lista *lp, FILE *fp, int numTotalPalavras) {
 ...
 * Side-Effects: none
 *
 * Description: output all words and ocurrences to file, from the end to the beggining of the list
 *
 *****************************************************************************/

void escrevePalavrasFim(t_lista *lp, FILE *fp, int numTotalPalavras) {

  t_lista *aux; /* auxiliar pointers to travel through the list */
  aux = lp;
  
  if(getProxElementoLista(aux) != NULL){
	escrevePalavrasFim(getProxElementoLista(aux), fp, numTotalPalavras);
  }
  escreveUmaPalavra((t_palavra*) getItemLista(aux), fp, numTotalPalavras);
